...
ec2_resource_paris = boto3.resource('ec_2', region_name="eu-west-3")

ec2_client_frankfurt = boto3.client('ec2', region_name="eu-central-1")
ec2_resource_frankfurt = boto3.resource('ec_2', region_name="eu-central-1")
...
reservation_frankfurt = ec2_client_frankfurt.describe_instances()['Reservations']
